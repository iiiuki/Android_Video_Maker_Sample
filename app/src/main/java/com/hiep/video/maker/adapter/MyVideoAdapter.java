...
public class MyVideoAdapter extends ArrayAdapter<VideoEntity> {
    ...
    public MyVideoAdapter(Context context, int resource, List<VideoEntity> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(context).load(item.getFilePath()) // or URI/path
    ...
    class ViewHolder {
        ...
        public ViewHolder(View view) {
            mCoverImage=(ImageView)view.findViewById(R.id.iv_item_my_video_cover);
            mNameText=(TextView)view.findViewById(R.id.tv_item_my_video_name);
            mTimeText=(TextView)view.findViewById(R.id.tv_item_my_video_duration);
        }
    }
}
